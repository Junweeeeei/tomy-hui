...
const service_des = `As your business grows, so do your electrical needs. Our Electrical Load Supply Upgrading 
                      service is designed to support expansion by providing reliable upgrades to handle increased power demands. 
                      With a focus on safety, efficiency, and minimal disruption, 
                      we help you scale seamlessly while safeguarding system stability.`
...
const ServiceELSU = ({ setSelectedPage }: Props) => {
  return (
    <section id="serviceELSU" className="md:h-full">
          ...
          >
            <div className='justify-content mx-auto w-full gap-16 md:flex'>
              <div className='mt-16 basis-1/2 md:mt-0'>
                <div className='my-5'>
                  <p className='font-bold md:text-5xl text-2xl'>Electrical Load Supply Upgrading</p>
