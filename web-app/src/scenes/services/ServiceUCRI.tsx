...
const service_des = `Our team provides comprehensive underground cabling and routing installation services, 
                    ensuring seamless and efficient routing of electrical systems. With a meticulous approach to 
                    planning and installation, we meet the demands of each project with a focus on durability and 
                    safety, keeping your operations running smoothly.`
...
const ServiceUCRI = ({ setSelectedPage }: Props) => {
  return (
    <section id="serviceUCRI" className="md:h-full">
          ...
          >
            <div className='justify-content mx-auto w-full gap-16 md:flex'>
              <div className='mt-16 basis-1/2 md:mt-0'>
                <div className='my-5'>
                  <p className='font-bold md:text-5xl text-2xl'>Underground Cabling & Routing Installation</p>
